...
Per importare velocemente i dati in QGIS, seleziona il file geografico di interesse, scegli il formato `GeoJSON`, copia l'url e incollalo in QGIS nella finestra del [gestore delle sorgenti dati](https://docs.qgis.org/3.40/en/docs/user_manual/managing_data_source/opening_data.html#loading-a-layer-from-a-file).
