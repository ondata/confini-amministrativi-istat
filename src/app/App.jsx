...
export function App() {
    ...
    function Map() {
        ...
        return <div ref={mapRef} className="grow overflow-hidden max-sm:hidden"></div>;
    }
    ...
    return (
        <main className="min-h-screen bg-oblue-light text-oblue-dark flex flex-row justify-center">
            <section className="p-6 max-w-sm">
                <p className="mb-4">
                    Questo progetto nasce nel <a rel="noopener noreferrer" target="_blank"
                        href="https://github.com/teamdigitale/confini-amministrativi-istat" className="underline">novembre del
                        2019</a>{' '}
                    nell'ambito delle attività del <a rel="noopener noreferrer" target="_blank"
                        href="https://teamdigitale.governo.it/" className="underline">Team per la Trasformazione Digitale</a>.
                    Dopo più di un anno di inattività viene preso in mano dall'<a rel="noopener noreferrer" target="_blank"
                        href="https://www.ondata.it/" className="underline">associazione OnData</a>{' '}
                    nel <a rel="noopener noreferrer" target="_blank"
                        href="https://github.com/ondata/confini-amministrativi-istat" className="underline">marzo del 2021</a>.
                    Questa è l'ultima evoluzione del progetto originale sviluppata nel corso del 2023.
                </p>
                <p className="mb-4">
                    La fonte ufficiale delle risorse geografiche è l'<a rel="noopener noreferrer" target="_blank"
                        href="https://www.istat.it/it/archivio/222527" className="underline">ISTAT</a>.
                    Altre fonti ufficiali con cui i dati sono arricchiti sono l'<a rel="noopener noreferrer" target="_blank"
                        href="https://www.anagrafenazionale.interno.it/" className="underline">ANPR</a> e
                    il progetto <a rel="noopener noreferrer" target="_blank"
                        href="https://www.agid.gov.it/it/dati/vocabolari-controllati" className="underline">OntoPiA</a>.
                </p>
                <p className="mb-12">
                    Usa i controlli sottostanti per selezionare la risorsa geografica di interesse.
                    Seleziona il paese, l'edizione dei dati e il livello di suddivisione amministrativa.
                    Eventualmente seleziona anche il territorio specifico e la sotto suddivisione amministrativa.
                    Puoi vedere i confini amministrativi nella mappa qui a fianco.
                    Ogni territorio è cliccabile e il tooltip mostra i dati associati.
                    Puoi scaricare la risorsa geografica selezionata in uno qualsiasi dei formati supportati.
                    Tutte le risorse qui presenti sono rilasciate con <a rel="noopener noreferrer" target="_blank"
                        href="https://www.agid.gov.it/it/dati/open-data" className="underline">licenza Open Data</a>.
                </p>
                <Controls />
            </section>
            <Map />
